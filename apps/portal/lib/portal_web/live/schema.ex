defmodule PortalWeb.Live.Schema do
    ...
    <div class="w-full  bg-base-100 p-4 rounded-lg">
      ...
      <div class="grid grid-cols-7 mt-1  place-items-center">
        ...
        <div class="col-start-3 border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">8:00 - AKU intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">15:00 - AKU intervju</p>
        </div>
        <div class="col-start-4 border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">11:00 - AKU intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">14:00 - AKU intervju</p>
        </div>
        <div class="col-start-5 border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">10:00 - AKU intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">13:00 - AKU intervju</p>
        </div>
        ...
        <div class=" border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-pink-200 dark:bg-pink-600 dark:text-pink-100">9:00 - ULF intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-pink-200 dark:bg-pink-600 dark:text-pink-100">11:00 - ULF intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">14:00 - AKU intervju</p>
        </div>
        <div class="col-start-2 border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-pink-200 dark:bg-pink-600 dark:text-pink-100">8:00 - ULF intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-pink-200 dark:bg-pink-600 dark:text-pink-100">10:00 - ULF intervju</p>
        </div>
        <div class="col-start-3 border border-solid w-full h-28  ">
        ...
        <div class="col-start-4 border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">10:00 - AKU intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">12:00 - AKU intervju</p>
        </div>
        <div class="col-start-5 border border-solid w-full h-28  ">
        ...
        <div class=" border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-purple-200 dark:bg-purple-600 dark:text-purple-100">Användarrådet möte</p>
        </div>
        <div class="col-start-2 border border-solid w-full h-28  ">
        ...
        <div class="col-start-3 border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-blue-200 dark:bg-blue-600 dark:text-blue-100">Möte med intervjuledare</p>
        </div>
        <div class="col-start-4 border border-solid w-full h-28  ">
          ...
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">8:00 - AKU intervju</p>
          <p class="text-xs px-2 mt-1 truncate  bg-green-200 dark:bg-green-600 dark:text-green-100">9:30 - AKU intervju</p>
          <p class="text-xs px-2 mt-1 truncate  hover:underline cursor-pointer font-medium ">3 more</p>
        </div>
        <div class="col-start-5 border border-solid w-full h-28  ">
